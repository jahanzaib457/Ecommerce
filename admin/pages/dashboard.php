          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Categorys</p>
                <?php
                $fetch_cat = "SELECT * FROM `table_categories`";
                $run_cat = mysqli_query($conn,$fetch_cat);
                $count_cat = mysqli_num_rows($run_cat);
                ?>
                <h4 class="mb-0"><?php echo $count_cat ; ?></h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                $fetch_pro = "SELECT * FROM `table_product`";
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                $fetch_emp = "SELECT * FROM `table_employee`";
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                $fetch_con = "SELECT * FROM `user_contact_us`";
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <div class="timeline timeline-one-side">
                <?php
                $execute_con = mysqli_query($conn,"SELECT * FROM `user_contact_us` limit 8");
